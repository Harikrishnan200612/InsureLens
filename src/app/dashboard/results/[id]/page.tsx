...
import { DEMO_RESULT, DEMO_POLICY } from '@/lib/demoData';
...
export default function ClaimResultPage() {
  ...
  // Read dynamically stored claim inputs if present
  ...
  return (
    <div style={{ maxWidth: 1040, margin: '0 auto' }}>
      ...
      {/* Primary Header Card with Treatment & Hospital */}
      <div style={{ background: '#FFFFFF', borderRadius: 14, border: '1px solid #E2E8F0', padding: 28, marginBottom: 28 }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(240px, 1fr))', gap: 20 }}>
          ...
          {/* 2. Potential Insurance Contribution */}
          ...
          {/* 3. Estimated Patient Contribution */}
